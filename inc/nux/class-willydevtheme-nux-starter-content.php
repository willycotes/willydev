<?php
/**
 * willydevtheme NUX Starter Content Class
 *
...
if ( ! class_exists( 'willydevtheme_NUX_Starter_Content' ) ) :

	/**
	 * The willydevtheme NUX Starter Content class
	 */
	class willydevtheme_NUX_Starter_Content {
		/**
		 * Setup class.
		 *
		 * @since 2.2.0
		...
		public function __construct() {
			...
			if ( ! isset( $_GET['sf_starter_content'] ) || 1 !== absint( $_GET['sf_starter_content'] ) ) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
				add_filter( 'willydevtheme_starter_content', '__return_empty_array' );
			}
		}

		/**
		 * Remove default widgets on activation
		 * Set an option so that this is only done the first time the user activates willydevtheme.
		 *
		 * @since 2.2.0
		 * @return void
		 */
		public function remove_default_widgets() {
			if ( false === (bool) get_option( 'willydevtheme_cleared_widgets' ) && true === (bool) get_option( 'willydevtheme_nux_fresh_site' ) ) {
				update_option( 'sidebars_widgets', array( 'wp_inactive_widgets' => array() ) );
				update_option( 'willydevtheme_cleared_widgets', true );
			}
		}
		...
		public function starter_content() {
			$starter_content = array(
				'posts'       => array(
					'home'    => array(
						'post_title' => esc_attr__( 'Homepage', 'willydevtheme' ),
						'template'   => 'template-fullwidth.php',
					),
					'about'   => array(
						'post_type'    => 'page',
						'post_title'   => __( 'About', 'willydevtheme' ),
						'post_content' => __( 'You might be an artist who would like to introduce yourself and your work here or maybe you&rsquo;re a business with a mission to describe.', 'willydevtheme' ),
					),
					'contact' => array(
						'post_type'    => 'page',
						'post_title'   => __( 'Contact', 'willydevtheme' ),
						'post_content' => __( 'This is a page with some basic contact information, such as an address and phone number. You might also try a plugin to add a contact form.', 'willydevtheme' ),
					),
					'blog',
				),
				'attachments' => array(
				...
				'nav_menus'   => array(
					'primary'   => array(
						'name'  => __( 'Primary Menu', 'willydevtheme' ),
						'items' => array(
							'shop'         => array(
								'type'      => 'post_type',
								'object'    => 'page',
					...
					'secondary' => array(
						'name'  => __( 'Secondary Menu', 'willydevtheme' ),
						'items' => array(
							'my_account' => array(
								'type'      => 'post_type',
								'object'    => 'page',
					...
					'handheld'  => array(
						'name'  => __( 'Handheld Menu', 'willydevtheme' ),
						'items' => array(
							'shop' => array(
								'type'      => 'post_type',
								'object'    => 'page',
			...
			$woocommerce_pages        = willydevtheme_NUX_Admin::get_woocommerce_pages();
			...
			add_theme_support( 'starter-content', apply_filters( 'willydevtheme_starter_content', $starter_content ) );
		}
		...
		public function filter_start_content( $content, $config ) {
			...
			if ( true !== (bool) get_option( 'willydevtheme_nux_fresh_site' ) ) {
				unset( $content['posts']['about'] );
				unset( $content['posts']['contact'] );
				unset( $content['nav_menus'] );
				unset( $content['widgets'] );
		...
		public function add_product_tax() {
			...
			add_filter( 'willydevtheme_product_categories_shortcode_args', array( $this, 'filter_sf_categories' ) );
		}
		...
		/**
		 * Filter willydevtheme Product Categories shortcode.
		 *
		 * @since 2.2.0
		...
		private function starter_content_products() {
			$accessories_name        = esc_attr__( 'Accessories', 'willydevtheme' );
			$accessories_description = esc_attr__( 'A short category description', 'willydevtheme' );

			$hoodies_name        = esc_attr__( 'Hoodies', 'willydevtheme' );
			$hoodies_description = esc_attr__( 'A short category description', 'willydevtheme' );

			$tshirts_name        = esc_attr__( 'Tshirts', 'willydevtheme' );
			$tshirts_description = esc_attr__( 'A short category description', 'willydevtheme' );

			$products = array(
				// Accessories.
				'beanie'             => array(
					'post_title'     => esc_attr__( 'Beanie', 'willydevtheme' ),
				...
				'belt'               => array(
					'post_title'     => esc_attr__( 'Belt', 'willydevtheme' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'cap'                => array(
					'post_title'     => esc_attr__( 'Cap', 'willydevtheme' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
					'thumbnail'      => '{{cap-image}}',
				...
				'sunglasses'         => array(
					'post_title'     => esc_attr__( 'Sunglasses', 'willydevtheme' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'hoodie-with-logo'   => array(
					'post_title'     => esc_attr__( 'Hoodie with Logo', 'willydevtheme' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'hoodie-with-pocket' => array(
					'post_title'     => esc_attr__( 'Hoodie with Pocket', 'willydevtheme' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'hoodie-with-zipper' => array(
					'post_title'     => esc_attr__( 'Hoodie with Zipper', 'willydevtheme' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'hoodie'             => array(
					'post_title'     => esc_attr__( 'Hoodie', 'willydevtheme' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'long-sleeve-tee'    => array(
					'post_title'     => esc_attr__( 'Long Sleeve Tee', 'willydevtheme' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'polo'               => array(
					'post_title'     => esc_attr__( 'Polo', 'willydevtheme' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'tshirt'             => array(
					'post_title'     => esc_attr__( 'Tshirt', 'willydevtheme' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
				...
				'vneck-tee'          => array(
					'post_title'     => esc_attr__( 'Vneck Tshirt', 'willydevtheme' ),
					'post_content'   => 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
					'post_type'      => 'product',
					'comment_status' => 'open',
			...
			return apply_filters( 'willydevtheme_starter_content_products', $products );
		}
		...
		private function homepage_blocks_content() {
			$content = '
				...
				<h2 style="text-align:center">' . __( 'Shop by Category', 'willydevtheme' ) . '</h2>
				<!-- /wp:heading -->
				...
				<!-- wp:heading {"align":"center"} -->
				<h2 style="text-align:center">' . __( 'New In', 'willydevtheme' ) . '</h2>
				<!-- /wp:heading -->
				...
				<!-- wp:heading {"align":"center"} -->
				<h2 style="text-align:center">' . __( 'Fan Favorites', 'willydevtheme' ) . '</h2>
				<!-- /wp:heading -->

				<!-- wp:woocommerce/product-top-rated {"columns":4} /-->

				<!-- wp:heading {"align":"center"} -->
				<h2 style="text-align:center">' . __( 'On Sale', 'willydevtheme' ) . '</h2>
				<!-- /wp:heading -->

				<!-- wp:woocommerce/product-on-sale {"columns":4} /-->

				<!-- wp:heading {"align":"center"} -->
				<h2 style="text-align:center">' . __( 'Best Sellers', 'willydevtheme' ) . '</h2>
				<!-- /wp:heading -->
		...
		private function replace_homepage_blocks_symbols() {
			...
			if ( ! empty( $hero ) ) {
				$cover = '
					...
					<h1 style="text-align:center">' . __( 'Welcome', 'willydevtheme' ) . '</h1>
					<!-- /wp:heading -->

					<!-- wp:paragraph {"align":"center","customTextColor":"#000000"} -->
					<p style="color:#000000;text-align:center" class="has-text-color">' . __( 'This is your homepage which is what most visitors will see when they first visit your shop.', 'willydevtheme' ) . '</p>
					<!-- /wp:paragraph -->

					<!-- wp:paragraph {"align":"center","customTextColor":"#000000"} -->
					<p style="color:#000000;text-align:center" class="has-text-color">' . __( 'You can change this text by editing the "Welcome" page via the "Pages" menu in your dashboard.', 'willydevtheme' ) . '</p>
			...
			if ( ! empty( $products ) ) {
				$handpicked = '
					<!-- wp:heading {"align":"center"} -->
					<h2 style="text-align:center">' . __( 'We Recommend', 'willydevtheme' ) . '</h2>
					<!-- /wp:heading -->
		...
		private function validate_tasks( $tasks ) {
			$valid_tasks = apply_filters( 'willydevtheme_valid_tour_tasks', array( 'homepage', 'products' ) );
...
return new willydevtheme_NUX_Starter_Content();
